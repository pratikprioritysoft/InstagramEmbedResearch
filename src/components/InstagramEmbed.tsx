 ...
 * @param maxWidth - Maximum width of the embed (default: 540)
 * @param hideCaption - Whether to hide the caption (default: false)
 */
function InstagramEmbed({ url, maxWidth = 540, hideCaption = false }: InstagramEmbedProps) {
